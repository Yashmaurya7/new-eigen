...
export function CompareDemo() {
  return (
    <div className="min-h-screen bg-black  flex flex-col items-center gap-8 pt-32  ">
      {/* Heading */}
      <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-blue-600 text-center px-4 sm:px-8">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between w-full gap-8">
        {/* Left Text Block */}
        <div className=" hidden sm:block w-full md:w-1/4 bg-black p-4 rounded-lg shadow-lg flex flex-col justify-center">
          ...
          <div className="relative p-1 bg-gradient-to-r from-white to-blue-600 rounded-lg">
            <div className="bg-black p-4 rounded-lg shadow-lg">
              <Compare
                ...
                className="h-[250px] w-[250px] md:h-[600px] md:w-[600px] rounded-md"
                slideMode="hover"
                autoplay={true}
              />
            </div>
        ...
        {/* Right Text Block */}
        <div className="hidden sm:block w-full md:w-1/4 bg-black p-4 rounded-lg shadow-lg flex flex-col justify-center pl-8">
